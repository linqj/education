 ...
 * @开发作者 :中青至诚教育咨询有限公司 
 */
public class Personnel extends BaseBean implements Serializable {
    /** id (主健ID) (无默认值) */
    private Long id;
    ...
    public Integer getPersonnelSort() {
        return personnelSort;
    }

    public void setPersonnelSort(Integer personnelSort) {
        this.personnelSort = personnelSort;
    }
