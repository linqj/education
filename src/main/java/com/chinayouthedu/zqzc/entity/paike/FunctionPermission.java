...
/**
 * @表名称 zczx_function_permission
 * @开发日期 2018-03-12 11:09:49
 * @开发作者 :中青至诚教育咨询有限公司 
 */
public class FunctionPermission extends BaseBean implements Serializable {
    /** id (主健ID) (无默认值) */
    private Long id;
    ...
    public void setProductFunctionId(Long productFunctionId) {
