...
public class EmailUtils {
	...
	public static void main(String[] args) throws Exception {
		PropertyUtil prop = PropertyUtil.getInstance("config/tasksms");
		System.out.println(prop.getProperty("fromEmail") + prop.getProperty("toEmail") + prop.getProperty("emailName")
				+ prop.getProperty("emailPassword"));
		// 样例
		// EmailUtils.sendMail(prop.getProperty("fromEmail"),
		// prop.getProperty("toEmail"), prop.getProperty("emailName"),
